...
set -gx VIRTUAL_ENV '/Users/gimmingyu/Desktop/oz/kim&ham/new_passion_fruit/.venv'
...
if test -n new-passion-fruit-py3.13
    set -gx VIRTUAL_ENV_PROMPT new-passion-fruit-py3.13
else
